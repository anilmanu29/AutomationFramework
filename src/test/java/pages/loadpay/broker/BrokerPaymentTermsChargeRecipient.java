...
public class BrokerPaymentTermsChargeRecipient extends TestBase {
	...
	public @FindBy(xpath = ".//*[@id='PaymentDate']")
	WebElement click_paymentdate;
	
	public @FindBy(xpath = "//*[text()='Prev']")
	WebElement click_predate;
	
	public @FindBy(xpath = "//*[contains(@class, 'ui-datepicker-today')]//following::td[1]")
	WebElement click_nextdate;
	...
	//AdminPayment Terms
	public @FindBy(xpath = ".//*[@id='angularScope']/div[1]/div/div[2]/div/div/div/div[1]/div[3]/div[1]/a[7]")
	WebElement Click_AdminPaymentTerms;
