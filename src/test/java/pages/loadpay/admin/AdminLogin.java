...
public class AdminLogin extends TestBase
{
	...
	public @FindBy(xpath=".//*[@id='angularScope']/div[1]/div/div[1]/div/nav/div[2]/ul/li[3]/a")
	...
	public @FindBy(xpath="//input[@value='Search']")
	
	WebElement ClickonSearchButton;
	

	public @FindBy(xpath="//a[contains(@class,'ng-binding')]")
