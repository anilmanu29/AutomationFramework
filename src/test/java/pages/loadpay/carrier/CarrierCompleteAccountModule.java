...
public class CarrierCompleteAccountModule extends TestBase {
	...
	public @FindBy(xpath = ".//*[@id='NotifyByNewPayment']")
	WebElement uncheck_NotifyByNewPayment;
	
	public @FindBy(xpath = ".//*[@id='NotifyByPayMeNow']")
	WebElement uncheck_NotifyByPayMeNow;
	
	public @FindBy(xpath = ".//*[@id='NotifyByDeposit']")
	WebElement uncheck_NotifyByDeposit;
	
	public @FindBy(xpath = ".//*[@id='formNotifications']/div[5]/input")
	WebElement uncheck_CarrierNotificationUpdate;
