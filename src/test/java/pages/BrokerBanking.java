...
import testcases.BrokerBankingTest;
	...
	public String getPennyVerificationAmount() throws InterruptedException {
		...
		for (int i = 0; i < count; i++) {
			if (banking.get(i).getText().equalsIgnoreCase(BrokerBankingTest.acountname)) {
				...
				// Object amt= js.executeScript("var value =
				// document.evaluate(\".//*[@id='angularScope']/div[1]/div/div[2]/div/div/div/div[1]/div[3]/div[2]/div[2]/div/div/div[1]/div/div/div/p[9]/span/text()\",document,
				// null, XPathResult.STRING_TYPE, null ); return value.stringValue;");
				j = i;
				break;
			}
		}
