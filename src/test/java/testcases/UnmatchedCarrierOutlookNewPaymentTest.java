...
import pages.UnmatchedCarrierOutlook;
import pages.UnmatchedCarrierOutlookNewPayment;
import pages.outlooklogin;

public class UnmatchedCarrierOutlookNewPaymentTest extends TestBase {
	
	UnmatchedCarrierOutlookNewPayment outlookk;
	...
	public void setUp() throws IOException, AWTException {
		...
		outlookk = new UnmatchedCarrierOutlookNewPayment();
	}

	@Test(dataProvider = "getoutlookLoginData", priority=34)
	...
	public void outlookloginTest() throws InterruptedException, AWTException {
	 ...
	 @Test(dataProvider ="getCarrierRegisterData",priority=36)
