...
public class UnmatchedCarrierOutlookTest extends TestBase {
	...
	UnmatchedCarrierOutlook outlookk;
	...
	public void setUp() throws IOException, AWTException {
		...
		outlookk = new UnmatchedCarrierOutlook();
	}

	@Test(dataProvider = "getoutlookLoginData", priority=33)
	...
	public void outlookloginTest() throws InterruptedException, AWTException {
	 ...
	 @Test(dataProvider ="getCarrierRegisterData",priority=35)
